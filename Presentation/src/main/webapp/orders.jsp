        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mt-0 font-weight-bold mb-2">Commande n°<%= i%></h5>
                            <%
                                if (user.getRole().equals("ADMIN"))
                                {
                            %>
                                <h6 class="mt-0 font-weight-bold mb-2">Nom du client : <%= new UserService().getById(o.getIdUser()).getFirstName() +" "+new UserService().getById(o.getIdUser()).getLastName() %></h6>
                            <%
                                 }
                            %>
                            <h6 class="mt-0 font-weight-bold mb-2">Status : <%= o.getStatus()%></h6>
                            ...
                            <%
                                ...
                                for(Map.Entry<Integer,Integer> entry : productList.entrySet()){
                                    ...
                                    total = total + price;
                            %>
                                <h5><%= entry.getValue() %>x - <%= productDto.getName() %></h5>
